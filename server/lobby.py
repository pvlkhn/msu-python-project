...
class Games:
    ...
    def __init__(self, registry_id: str = ""):
        """Creates a new registry for games
    ...
    def get(self, game_id: str) -> Optional[GameServer]:
        """Returns a `GameServer` object given its game id
    ...
    def add(self, game: GameServer) -> str:
        """Inserts a game into storage, generates and returns game id for it
    ...
    def remove(self, game_id: str) -> None:
        """Removes a game by its id, if present
...
class LobbyServer(Flask):
    """A web-server capable of listing currently hosted games
